    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            את לא צריכה להיות רואת חשבון וגם לא עורכת דין. את רק צריכה שהכסף יכנס בזמן. במקום לשלוח וואטסאפים, לריב על "מחציות", לחשב הצמדות ולשמוע תירוצים - תני לטכנולוגיה שלנו להיות החיץ (<bdi dir="ltr">Buffer</bdi>) ביניכם.
          </p>
        </div>
